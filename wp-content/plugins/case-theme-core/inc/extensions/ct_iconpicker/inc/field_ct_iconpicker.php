...
if (!class_exists('ReduxFramework_ct_iconpicker')) {
    class ReduxFramework_ct_iconpicker {
        function __construct($field = array(), $value = '', $parent) {
            $this->parent = $parent;
            $this->field = $field;
            $this->value = $value;

            $this->extension_url = ct_redux_extensions()->extensions_url . 'ct_iconpicker/';
        }
        ...
        function render() {
            ...
            ?>
                <select name="<?php echo $this->field['name'] . $this->field['name_suffix']; ?>" class="cms-iconpicker">
                    <option value=""><?php esc_html_e('No Icons', CT_TEXT_DOMAIN) ?></option>
                    <?php
        ...
        public function enqueue() {
            ...
            if (!wp_script_is('jquery.fonticonpicker.js')) {
                wp_enqueue_script('jquery.fonticonpicker.js', CT_URL . 'assets/lib/iconpicker/jquery.fonticonpicker.js', array('jquery'), 'all', true);
            }
            if (!wp_script_is('cms-iconpicker-js')) {
                wp_enqueue_script(
                    'cms-iconpicker-js',
                    $this->extension_url . 'inc/field_ct_iconpicker.js',
        ...
        public function get_icons(){
            ...
            $icons = apply_filters("redux_ct_iconpicker_field/get_icons", $icons);
