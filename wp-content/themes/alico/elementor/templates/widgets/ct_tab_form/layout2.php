...
<?php if(isset($tabs) && !empty($tabs) && count($tabs)): ?>
    <div class="ct-tab-form ct-tab-form2">
        <div class="ct-tabs-title">
            <?php foreach ($tabs as $key => $title): 
                ...
                ?>
                <div class="ct-tab-title <?php if($active_tab == $key + 1) { echo 'active'; } ?>" data-target="#<?php echo esc_attr($title['_id']); ?>" style="background-color: <?php echo esc_attr($tab_title_bgcolor); ?>">
                    <div class="ct-tab-number"><span><?php if($key < 9) { echo '0'; }; ?><?php echo esc_attr($key+1); ?></span></div>
                    ...
                    <?php } else {
                        ...
                        <div class="ct-tab-icon">
                            <?php echo ct_print_html($thumbnail_icon_title); ?>
                        </div>
                    <?php } ?>
                    <div class="ct-tab-heading">
                        <div class="ct-tab-inner">
