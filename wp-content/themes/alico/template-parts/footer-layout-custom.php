<?php
$footer_layout_custom = alico_get_opt('footer_layout_custom');
$custom_footer = alico_get_page_opt('custom_footer', 'false');
$footer_layout_custom_page = alico_get_page_opt('footer_layout_custom');
