...
class GetInTouch_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'getintouch_widget',
            esc_html__('* Get In Touch', 'alico'),
            array('description' => esc_html__('Get In Touch Widget', 'alico'),)
        );
    }
        ...
        <section class="ct-getintouch widget">
            ...
            <div class="ct-getintouch-inner">
                ...
                <?php if(!empty($btn_text)) : ?>
                    <div class="ct-getintouch-item">
                        <a class="btn" href="<?php echo esc_url($btn_link); ?>"><i class="fac fac-location-arrow space-right"></i><?php echo esc_attr( $btn_text ); ?></a>
                    </div>
                <?php endif; ?>
            </div>
        </section>
    ...
    function form( $instance ) {
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('address_label')); ?>"><?php esc_html_e( 'Address Label', 'alico' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('address_text')); ?>"><?php esc_html_e( 'Address', 'alico' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('phone_label')); ?>"><?php esc_html_e( 'Phone Label', 'alico' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('phone_text')); ?>"><?php esc_html_e( 'Phone', 'alico' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('time_label')); ?>"><?php esc_html_e( 'Time Label', 'alico' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('time_text')); ?>"><?php esc_html_e( 'Time', 'alico' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('btn_text')); ?>"><?php esc_html_e( 'Button Text', 'alico' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('btn_link')); ?>"><?php esc_html_e( 'Button Link', 'alico' ); ?></label>
